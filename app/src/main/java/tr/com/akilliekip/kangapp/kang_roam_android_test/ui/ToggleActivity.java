            ...
            case R.id.swNotification:
                if (swNotification.isChecked()) {
                    Roam.setForegroundNotification(true,"Roam Example","Click here to redirect the app",
                            R.drawable.ic_geospark,"tr.com.akilliekip.kangapp.kang_roam_android_test.ui.MainActivity","tr.com.akilliekip.kangapp.kang_roam_android_test.service.ForegroundService");
                } else {
